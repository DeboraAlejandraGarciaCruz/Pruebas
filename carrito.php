...
<?php    
   ...
   if (isset($_SESSION['carrito']) && sizeof($_SESSION['carrito']) > 0) : 
         ...
         while ($row = mysql_fetch_array($res)) { 
               echo "<tr> 
                           ...
                           <td width=\"5%\"><a href=\"carrito.php?act=del&item=".$row['id_item']."\"><img src=\"images/delete.png\" border=\"0\"></a></td> 
                       </tr>"; 
  ...
  echo "<br><br><a href=\"\">[realizar la compra]</a> - <a href=\"index.php\">[seguir comprando]</a>";          
