...
<a href="carrito.php"><img src="images/carrito.gif" border="0"> [ver carrito]</a> 
<hr> 
<br> 
...
<?php    
   ...
   if (isset($_GET['cat']) && is_numeric($_GET['cat'])) { 
      ...
      if (!mysql_num_rows($res)) { 
         echo "No hay items en esta categoría!"; 
      } else {       
         echo "<ul>"; 
         while ($row = mysql_fetch_array($res)) { 
       
            echo "<li><b><a href=\"index.php?cat=".$row['id_cat']."&item=".$row['id_item']."\">".$row['nombre']."</a></b></li> 
                     <br><br>"; 
         } 
         echo "</ul>"; 
      }    
   ...
   /* muestra categorias existentes en la DB */ 
      ...
      while ($row = mysql_fetch_array($res)) { 
         ...
         echo "<li><b><a href=\"index.php?cat=".$row['id_cat']."\">".$row['nombre']."</a></b></li> 
